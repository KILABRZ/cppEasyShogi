...
新增了一系列的，可以透過 String 和 Shogi 互動的介面。

包含透過 string 進行下棋，和一個可以把盤面（回合數/盤面全狀）和字串作互相轉換的函數，

全部都包到了 Python 裡面。

使用 string 來存取的話，速度上變慢一點點，大概是多了 22% 的運行時間。
依然報暴打以前的設計。

以下是一篇完整的，從開始到結束的棋譜，應該是最短的棋局結束。

5756-,7162-,7776-,8384-,2858-,5354-,5655-,5455-,8855-,8485-,5533+